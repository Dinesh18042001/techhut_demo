...
export default function TechCareer() {
  return (
    <>
      <div className="techcareer-section mt-5 mb-5">
        <div className="container">
          ...
          <div className="row mt-4">
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon techcareer-icon2">
                    <img src="./assets/TechCareer/icon2.png" alt="" />
                  </div>
                  <div className="techcareer-section-card-text">
                    <h6>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon techcareer-icon3">
                    <img src="./assets/TechCareer/icon3.png" alt="" />
                  </div>
                  <div className="techcareer-section-card-text">
                    <h6>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon techcareer-icon4">
                    <img src="./assets/TechCareer/icon4.png" alt="" />
                  </div>
                  <div className="techcareer-section-card-text">
                    <h6>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon techcareer-icon5">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
              <div className="techcareer-section-card h-100">
                <div className="techcareer-section-card-tittle d-flex align-items-center gap-3 mb-3">
                  <div className="techcareer-section-card-icon techcareer-icon6">
